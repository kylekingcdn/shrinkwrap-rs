...
#[shrinkwrap(schema, inline, transform = MyTransform)]
...
impl TransformToNest<ApiDataNestedText> for MyTransform {
    type Data = ApiData;
...
impl TransformToNest<ApiDataNestedValue> for MyTransform {
    type Data = ApiData;
    ...
    fn transform_to_nest(
        ...
        ApiDataNestedValue { balance: 6.66f32 }
    }
}

/// Define the conversion from our **`value`** nest into the generated `value_text` sub-nest
impl TransformToNest<ApiDataNestedValueText> for MyTransform {
